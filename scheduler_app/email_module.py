...
def send_candidate_scheduler_email(candidate, client, interview, url):
...
def send_candidate_confirmed_times(candidate, interview):
...
def send_client_scheduler_email(candidate, client, interview, url):
...
def send_client_confirmation_email(candidate, client, interview, zoom_url, interview_datetime_client):
    candidate_full_name = candidate.first_name + ' ' + candidate.last_name
...
def send_candidate_confirmation_email(candidate, client, interview, zoom_url, interview_datetime_candidate):
